...
<body style="overflow: hidden;">
	<div class="row">
		<div class="col-md-10">
			...
			<div>
				<label class="kata4">Pernah nggk,merasa lembap atau pengap di area kewanitaanmu?</label>
			</div>
			<div class="sedih">
				<a href="IritasiMeter7.php"><img src="img/cewek_sedih.png" class="responsive" ></a>
			</div>
			<div class="seneng">
				<a href="IritasiMeter7.php"><img src="img/cewek_seneng.png" class="responsive" id="tisu"></a>
			</div>
			<div >
				<p class="kataPernah">Pernah</p>
				
			</div>
			<div >
				<p class="kataAc">Belum pernah</p>
			</div>
			<div class="bawah4">
