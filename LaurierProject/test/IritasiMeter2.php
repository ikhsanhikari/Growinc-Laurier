...
<body style="overflow: hidden;">
	<div class="row">
		<div class="col-md-10">
			...
			<div>
				<label class="kata2">Kamu lebih suka olahraga dimana?</label>
			</div>
			<div class="hanger">
				<a href="IritasiMeter3.php"><img src="img/indorr.png" class="responsive"></a>
				<a href="IritasiMeter3.php"><img src="img/outdoor.png" class="responsive" id="tisu"></a>
			</div>
			<div >
				<p class="kataHanger">Indoor</p>
			</div>
			<div >
				<p class="kataTisu">Outdoor</p>
			</div>
			<div class="bawah2">
