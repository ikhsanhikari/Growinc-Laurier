...
<body style="overflow: hidden;">
	<div class="row">
		<div class="col-md-10">
			...
			<div>
				<label class="kata2">Paling sering ke mana-mana naik</label>
			</div>
			<div class="kendaraan">
				<a href="IritasiMeter5.php"><img src="img/kendaraan.png" class="responsive" ></a>
			</div>
			<div class="kendaraan2">
				<a href="IritasiMeter5.php"><img src="img/mobil.png" class="responsive" id="tisu"></a>
			</div>
			<div >
				<p class="kataKendaraan">Ojek online, bus</p>
				<p class="kataKendaraan2">atau kereta</p>
			</div>
			<div >
				<p class="kataJeans3">Mobil</p>
			</div>
			<div class="bawah4">
